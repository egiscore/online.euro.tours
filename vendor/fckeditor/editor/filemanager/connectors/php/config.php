<?php
    ...
    require_once _ROOT.'admin/properties.php';
    include_once _ROOT.'includes/admin.php';
    _admin_auth_();
...
$Config['Enabled'] = true ;
        ...
        $Config['UserFilesPath'] = WWWROOT . 'data/hedit/';
        $Config['UserFilesAbsolutePath'] = _ROOT . 'data/hedit/';
