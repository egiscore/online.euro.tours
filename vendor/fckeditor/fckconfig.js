...
FCKConfig.ToolbarSets["SamoSoft"] = [
	['Source'],
	['Cut','Copy','Paste','PasteText','PasteWord','-'],
	['Undo','Redo','-','Find','Replace','-','SelectAll','RemoveFormat','Placeholder'],
	['FitWindow','-','About'],
	'/',
	['JustifyLeft','JustifyCenter','JustifyRight','JustifyFull'],
	['Bold','Italic','Underline','StrikeThrough','-','Subscript','Superscript'],
...
FCKConfig.ToolbarSets["Public"] = [
	...
	['JustifyLeft','JustifyCenter','JustifyRight','JustifyFull','-','Link','Unlink', 'Image'],
...
FCKConfig.LinkUploadAllowedExtensions	= ".(csv|doc|gif|jpeg|jpg|ods|odt|pdf|png|ppt|rar|rtf|xls|xml|zip)$" ;			// empty for all
