...
/*
    @changelog убрал кредитсы, убрал конфиг, перебор шрифтов заменил на glob
   $Id: kcaptcha.php 2130 2008-12-03 14:57:27Z MiRacLe $
*/
...
class KCAPTCHA{
	...
	function __construct() {
		...
		$fonts=glob(dirname(__FILE__).'/fonts/*.png');
